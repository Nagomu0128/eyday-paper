  ...
  async explain(input: ExplainInput): Promise<Explanation> {
    const content = await this.llm.complete({
      ...
      messages: [
        {
          role: "system",
          content: `You explain passages from academic papers clearly and concisely in ${langName(input.lang)}. Use only the provided selection and context; do not invent facts. If the selection is a formula or table, explain what it represents and defines.`,
        },
        {
          role: "user",
